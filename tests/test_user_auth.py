...
@allure.story("Cases for testing AUTH")
class TestUserAuth(BaseCase):
    ...
    @allure.title("CHECK AUTH W/O COOKIE & TOKEN")
    @allure.description("This test checks authorization status w/o sending auth cookie or token")
    @allure.testcase('https://software-testing.ru/lms/mod/assign/view.php?id=244502', 'CHECK AUTH W/O COOKIE & TOKEN')
    @allure.severity(allure.severity_level.CRITICAL)
